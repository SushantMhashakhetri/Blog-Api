...
import com.sushant.blog.config.AppConstants;
...
import com.sushant.blog.services.FileService;
...
public class PostController {
	...
	public ResponseEntity<PostResponse> getAllPosts(
		...
		PostResponse postResponse = this.postService.getAllPosts(pageSize, pageNo,sortBy,sortDir);
		return new ResponseEntity<PostResponse>(postResponse,HttpStatus.OK);
		
	}
	
	@GetMapping("/posts/{postId}")
	public ResponseEntity<PostDto> getAllPostsById(@PathVariable Integer postId){
